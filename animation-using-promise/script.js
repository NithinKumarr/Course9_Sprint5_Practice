...
promiseAnimation()
    .then(() => {
        return new Promise((resolve,reject)=>{
            setTimeout(() => { changeBorderColor();resolve();
        ...
        return new Promise((resolve,reject)=>{
            setTimeout(() => { makeBorderRounded();resolve();
        ...
        return new Promise((resolve,reject)=>{
            setTimeout(() => {displayHeading();resolve();
